...
def spectrum_csv_capture():
    ...
    filename='/home/noaa_gms/RSA_API-1.0.0014/traces/'+filetime+'.csv'
    ...
    while True:
        ...
        if a%10==0:
            f=open(filename,'a')
            np.savetxt(f, trace_array, delimiter=",",fmt='%s')
            print("   Saving...")
            f.close()
...
def spectrum_example():
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('/home/noaa_gms/RSA_API-1.0.0014/traces/spectrumExample.png')
    rsa.DEVICE_Disconnect()
...
def block_iq_example():
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('/home/noaa_gms/RSA_API-1.0.0014/traces/blockIqExample.png')
    rsa.DEVICE_Disconnect()
...
def dpx_example():
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('/home/noaa_gms/RSA_API-1.0.0014/traces/dpxExample.png')
    rsa.DEVICE_Disconnect()


"""################IF STREAMING EXAMPLE################"""
def config_if_stream(cf=1e9, refLevel=0, fileDir='/home/noaa_gms/RSA_API-1.0.0014/traces/', fileName='if_stream_test', durationMsec=100):
    rsa.CONFIG_SetCenterFreq(c_double(cf))
    rsa.CONFIG_SetReferenceLevel(c_double(refLevel))
...
def if_stream_example():
    ...
    config_if_stream(fileDir='/home/noaa_gms/RSA_API-1.0.0014/traces/',
...
def config_iq_stream(cf=1e9, refLevel=0, bw=10e6, fileDir='/home/noaa_gms/RSA_API-1.0.0014/traces/',
